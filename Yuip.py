...
def login():
    os.system('clear')
    print logo1
    print "\033[1;95mÂ«-----------------\033[1;91mDisclaimer\033[1;95m----------------»"
    time.sleep(0.05)
    ...
    print "\033[1;92m-«-----------------\033[1;91mSOMI BRAND BOY\033[1;95m----------------»"
        time.sleep(0.05)
        print "\033[1;93m■□\033[1;91m> \033[1;91m1.\x1b[1;92m Fast Cloning With out Fb ID\033[1;93m[New Update]"
        time.sleep(0.05)
        print "\033[1;93m■□\033[1;91m> \033[1;93m2.\x1b[1;94m REAL STAR WhatsApp Group   "
        time.sleep(0.05)
        print "\033[1;33m■□\033[1;91m> \033[1;96m3.\x1b[1;93m REAL STAR "
        time.sleep(0.05)
	print "\033[1;93m■□\033[1;91m> \033[1;m0.\033[1;95m Exit             "
	pilih_login()
	def pilih_login():
...
def Zeek():
    os.system('clear')
    print logo2
    print"\033[1;94m[1]\x1b[1;93mPakistan"
    time.sleep(0.05)
    print '\033[1;94m[0]\x1b[1;95mback'
    time.sleep(0.05)
    action()

def action():
    peak = raw_input('\n\033[1;97mCHOOSE:\033[1;93m')
    if peak =='':
        ...
        print 'Activitie This Tool is for Educational Purpose     '
        try:
            c = raw_input("\033[1;97mCHOOSE ANYONE : ")
            k="03"
            idlist = ('.txt')
    ...
    jalan ('\033[1;94mCode you choose: '+c)
    jalan ("\033[1;93mWait A While Start Cracking...")
    jalan ("\033[1;95mTo Stop Process Press Ctrl+z")
    jalan("\033[1;93m ▇▇▇▇▇▇▇▇▇▇")
    print 50* '\033[1;47m-'
    def main(arg):
        global cpb,oks
...
\033[1;95myoutube\033[1;97mhttps://w ww.youtube.comSomi rapper"""
